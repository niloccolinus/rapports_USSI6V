...
L’objectif de cet exercice est d'implémenter une classe en Python permettant de modéliser un triangle donné par ses trois sommets. Cette classe doit permettre de calculer diverses propriétés géométriques du triangle, telles que la longueur des côtés, l'aire, le type de triangle (rectangulaire ou non), et d'autres caractéristiques comme le cercle circonscrit.
